...
<body class="bg-gradient-to-tr from-[#e2e8f0] via-[#f1f5f9] to-[#dbeafe] min-h-screen flex items-center justify-center p-0 md:p-4 text-slate-800 antialiased">
    ...
    <div class="w-full max-w-md bg-white/40 backdrop-blur-xl border border-white/60 min-h-screen md:min-h-[812px] md:rounded-[40px] shadow-2xl flex flex-col justify-between relative overflow-hidden p-5 pb-24">
