...
<body class="bg-gradient-to-tr from-[#e2e8f0] via-[#f1f5f9] to-[#dbeafe] fixed inset-0 w-full h-full h-[100dvh] overflow-hidden flex items-center justify-center p-0 md:p-4 text-slate-800 antialiased select-none">
